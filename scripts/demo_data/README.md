...
As FastSurfer is limited by a $320 \times 320 \times 320$-voxel bounding box, the volume `downsampled_data_float32_rotated.nii.gz` has been cropped (from 336 voxels to 320 voxels) along the anterior-posterior axis and saved as `downsampled_data_float32_rotated_crop.nii.gz`.
